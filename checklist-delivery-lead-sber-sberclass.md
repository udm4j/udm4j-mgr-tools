...
9. Обеспечить заключение юридических договоров (если нужно)
...
3. Необходимо продумать возможные изменения GQL, open-api (rest/swagger) и бд схем (и любых других интеграционных контрактов) и сделать это заранее, чтобы не блокировать разработку.

4. Выполнить разработку в части бд, бек, фронт в фича-ветке. 
...
12. Необходимо закрыть все пункты [Definition of Done (DoD)](https://confluence.pcbltools.ru/confluence/x/irEUAg):
    ...
    * Провести тестирование (ручное, регрессионное, интеграционное, нагрузочное...)
...
13. <a name="development-merge"></a>Создайте pull request на [merge](https://confluence.pcbltools.ru/confluence/x/JekUAg) вашей фича-ветки в master (с целью получить лайки по PR/merge в master). Перед этим merge целевую ветку в фича-ветку, чтобы избежать конфликтов.
...
14. До наступления фича-фриза (ФФ) тикеты с типом Story должны быть переведены в статус IFT.
   
15. Установите артефакты, собранные из релизной ветки с вашей фича-веткой на stage. 
   
16. Проведите тестирование на стейдже:
...
17. На этапах тестирования при обнаружении багов, заводятся тикеты в jira, для их исправления. 
...
7. При необходимости небольшие срочные доработки могут быть выведены в минорных релизах.
   
8. Исправления дефектов (багов и инцидентов) могут быть выведены в пром в hotfix.
